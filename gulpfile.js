...
var source     = require('vinyl-source-stream'); //Use convention text streams with Gulp
...
var config = {
      ...
      paths     : {
        ...
        css   : [
          ...
          'node_modules/bootstrap/dist/css/toastr.css'
        ],
        dist  : './dist',
        mainJs: './src/main.js'
      }
...
gulp.task('default', ['html', 'js', 'images', 'css', 'open', 'watch']);